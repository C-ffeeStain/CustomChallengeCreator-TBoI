...
class CreateNewChallengeWindow(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.setFont(QFont("fonts/normal.ttf", 10))
        ...
        self.hp_desc.setFont(QFont("fonts/normal.ttf", 8))
        ...
        self.all_items_label.setFont(QFont("fonts/normal.ttf", 10, QFont.Bold))
        ...
        self.added_items_label.setFont(QFont("fonts/normal.ttf", 10, QFont.Bold))
        ...
        self.install_label = QLabel("It's time to install your challenge!", self)
        ...
        self.nextButton.move(175, 275)  # 275, 275
        self.nextButton.clicked.connect(self.nextPage)

        self.backButton = QPushButton("Back", self)
        self.backButton.move(50, 275)  # 155, 275
